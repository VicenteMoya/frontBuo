...
export default function OCRReview2() {
    ...
    // ✅ aquí no hay state; empezamos vacío
    ...
    const submit = async () => {
        ...
        try {
            await commitOCRAlbaran({
                type,
                origin: 'manual',           // ✅ diferencia frente a 'ocr'
                sourceImageName: fileName,  // ✅ aquí será "MANUAL" o lo que ponga el usuario
                items: lines
            });
    ...
    return (
        <Box p={2} component={Paper}>
            <Typography variant="h6" mb={2}>Pedido manual</Typography>
